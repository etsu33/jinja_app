...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[var(--kt-radius-control)] text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-[var(--kt-color-action-primary)] text-[var(--kt-color-action-primary-text)] shadow-[var(--kt-shadow-low)] hover:bg-[var(--kt-color-action-primary-hover)]",
        destructive:
          "bg-[var(--kt-color-status-error)] text-[var(--kt-color-text-inverse)] shadow-[var(--kt-shadow-low)] hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        outline:
        ...
        secondary:
          "border border-[var(--kt-color-border-default)] bg-[var(--kt-color-surface-default)] text-[var(--kt-color-text-primary)] shadow-[var(--kt-shadow-low)] hover:bg-[var(--kt-color-background-subtle)]",
        ghost:
