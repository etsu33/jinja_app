...
export default function ShrineCloseLink({ close }: Props) {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-1 rounded-lg px-2 py-1 text-sm font-semibold text-[var(--kt-color-text-secondary)] hover:bg-[var(--kt-color-surface-elevated)]"
    >
      ← {close.label}
    </button>
  );
